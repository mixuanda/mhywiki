        ...
        "Ver": {
            ...
            "L": {
                "BattleSkills": [
                    ...
                    {
                        "Name": "Short-Range Rapid Interdiction Fire",
                        "Desc": "Chevreuse quickly shoulders her musket and fires at her opponent(s), dealing <color style='color:#FF9999;'>AoE Pyro DMG</color>.<br>For a short duration after Chevreuse fires a shot, she will continuously restore HP to your active character on the field. The amount healed is based on her Max HP.<br>Hold to fire in a different fashion.<br><br><color style='color:#FFD780;'>Hold</color><br>Enter Aiming Mode, locking a target in her sights to fire a precise interdiction shot. If Chevreuse has an Overcharged Ball, then she will fire the Overcharged Ball instead, dealing greater <color style='color:#FF9999;'>Pyro DMG</color> in a larger area.<br>Chevreuse gains 1 Overcharged Ball every time a nearby character in the party triggers an Overloaded reaction, and can have up to 1 Overcharged Ball at a time.<br><br><color style='color:#FFD780;'>Arkhe: Ousia</color><br>Periodically, after Chevreuse's Short-Range Rapid Interdiction Fire hits, a Surging Blade will be called forth that deals Ousia-aligned <color style='color:#FF9999;'>Pyro DMG</color>.<br><br><i>\"Actually, training regulations only had the phrase \"interdiction fire,\" but the protagonist of this novel believes that even how stylish your terminology is can affect how motivated your troops are, which can put your opponents on the back foot right from the get-go... I think that's a good point, so I changed the regulations!\"</i>",
                        "Icon": "Skill_S_Chevreuse_01",
                        "ParamDesc": [
                            {
                                "Desc": "Press DMG",
                            ...
                            },
                            {
                                "Desc": "HP Regeneration Over Time",
                                "ParamLevelList": [
                                    "2.6667% Max HP+256.79184",
                                    "2.8667% Max HP+282.47458",
                                    "3.0667% Max HP+310.29758",
                                    "3.3333% Max HP+340.26077",
                                    "3.5333% Max HP+372.36423",
                                    "3.7333% Max HP+406.60788",
                                    "4.0% Max HP+442.9918",
                                    "4.2667% Max HP+481.51593",
                                    "4.5333% Max HP+522.1803",
                                    "4.8% Max HP+564.98486",
                                    "5.0667% Max HP+609.9297",
                                    "5.3333% Max HP+657.0147",
                                    "5.6667% Max HP+706.24",
                                    "6.0% Max HP+757.6055",
                                    "6.3333% Max HP+811.11127"
                                ]
                            },
                            {
                                "Desc": "Healing Duration",
                ...
                "PassiveSkills": [
                    {
                        "Name": "Vanguard's Coordinated Tactics",
                        "Desc": "When all party members are <color style='color:#FF9999;'>Pyro</color> and <color style='color:#FFACFF;'>Electro</color> characters and there is at least one Pyro and one Electro character each in the party:<br>Chevreuse grants \"Coordinated Tactics\" to nearby party members: After a character triggers the Overloaded reaction, the <color style='color:#FF9999;'>Pyro</color> and <color style='color:#FFACFF;'>Electro</color> RES of the opponent(s) affected by this Overloaded reaction will be decreased by 40% for 6s.<br>The \"Coordinated Tactics\" effect will be removed when the Elemental Types of the characters in the party do not meet the basic requirements for the Ascension Talent.",
                        "Icon": "UI_Talent_S_Chevreuse_05"
                    },
                    {
                        "Name": "Vertical Force Coordination",
                        "Desc": "After Chevreuse fires an Overcharged Ball using <color style='color:#FFD780;'>Short-Range Rapid Interdiction Fire</color>, nearby <color style='color:#FF9999;'>Pyro</color> and <color style='color:#FFACFF;'>Electro</color> characters in the party gain 1% increased ATK for every 1,000 Max HP Chevreuse has for 30s. ATK can be increased by up to 40% in this way.",
                        "Icon": "UI_Talent_S_Chevreuse_06"
                    },
                    {
                        "Name": "Double Time March",
                ...
                "Constellations": [
                    {
                        "Level": 1,
                        "Name": "Stable Front Line's Resolve",
                        "Desc": "When the active character with the \"Coordinated Tactics\" status (not including Chevreuse herself) triggers the Overloaded reaction, they will recover 6 Energy. This effect can be triggered once every 10s.<br>You must first unlock the Ascension Talent \"Vanguard's Coordinated Tactics.\"",
                        "Icon": "UI_Talent_S_Chevreuse_01"
                    },
                    {
                        "Level": 2,
                    ...
                    },
                    {
                        "Level": 4,
                        "Name": "The Secret to Rapid-Fire Multishots",
                        "Desc": "After using <color style='color:#FFD780;'>Ring of Bursting Grenades</color>, the Hold mode of <color style='color:#FFD780;'>Short-Range Rapid Interdiction Fire</color> will not go on cooldown when Chevreuse uses it. This effect is removed after Short-Range Rapid Interdiction Fire has been fired twice using Hold or after 6s.",
                        "Icon": "UI_Talent_S_Chevreuse_03"
                    },
                    {
                        "Level": 5,
