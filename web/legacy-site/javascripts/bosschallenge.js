$(function () {
                        ...
                        div: {
                            div: {
                                ...
                                event: {
                                    error: function (o) {
                                        $(o.sender).hide()
                                        $(o.sender).parent().render({ img: 'https://homdgcat.wiki/homdgcat-res/Mat/UI_ItemIcon_120864.png', a: { loading: lazy } })
                                    }
                                },
                                a: {
                                    loading: lazy
    ...
    function pic(text) {
        ...
        while (s.includes('{')) {
            var start = s.indexOf('{')
            var end = s.indexOf('}')
            s = s.replace(s.substring(start, end + 1), `<img src='https://homdgcat.wiki/homdgcat-res/UI/${s.substring(start + 1, end)}.png' class='elem'>`)
        }
