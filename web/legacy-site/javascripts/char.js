$(function () {
    ...
    function render_anni_2() {
        ...
        $('.head_left').each(function () {
            var rand_list = [
                'https://homdgcat.wiki/images/emote/Yunli/1.png',
                'https://homdgcat.wiki/images/emote/Yunli/2.png',
                'https://homdgcat.wiki/images/emote/Yunli/3.png',
            ]
                                    ...
                                    t: [
                                        {   
                                            ...
                                            event: {
                                                error: function (d) {
                                                    $(d.sender).hide()
                                                    $(d.sender).parent().render({ img: 'https://homdgcat.wiki/images/itemicon/Icon_Testmaterial01.png', a: { loading: lazy } })
                                                }
                                            },
                                            a: {
                                                loading: lazy
                                ...
                                },
                                {
                                    div: {
                                        ...
                                        event: {
                                            error: function (d) {
                                                $(d.sender).hide()
                                                $(d.sender).parent().render({ img: 'https://homdgcat.wiki/images/' + this_avatar.Icon.replaceAll('avatarshopicon', 'avataricon').toLowerCase() + '.png', a: { loading: lazy } })
    ...
    function rotate() {
        ...
        $('.keq_emote_div').each(function () {
            ...
            $(this).empty().render({
                img: `https://homdgcat.wiki/images/emote/Yunli/${this_emote}.png`
            })
        })
    }
