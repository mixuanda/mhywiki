                ...
                for (const r_data of records_temp) {
                    ...
                    for (const role_data of r_data.role) {
                        role_avatar.push({
                            ...
                            t: [
                                {
                                    img: `https://homdgcat.wiki/homdgcat-res/Avatar/UI_AvatarIcon_${role_data.avatar}.png`,
                                },
                                {
                        ...
                        role_weapon.push({
                            ...
                            t: [
                                {
                                    img: `https://homdgcat.wiki/homdgcat-res/Weapon/${weapon_data[role_data.weapon]}.png`
                                },
                                {
