$(function () {
  ...
  function Wave(i, w, stage_lv, stage_hlg, stage_eg) {
        ...
        span: [{
          ...
          div: [{
            span: function () {
              ...
              if (me["5"]) s += " <color style='color:#666;'>[".concat(((stage_eg ? stage_eg.HP ? stage_eg.HP : 1 : 1) * me["5"] * 100).toFixed(0), "%]</color>");
              if (t.HPShow) s += " <color style='color:#666;'>[".concat((t.HPShow * 100).toFixed(0), "%]</color>");
              return s;
            },
            class: 'monname',
            when: t.HP
            ...
            span: function () {
              ...
              if (me["6"]) s += " <color style='color:#666;'>[".concat(((stage_eg ? stage_eg.SPD ? stage_eg.SPD : 1 : 1) * me["6"] * 100).toFixed(0), "%]</color>");
              if (t.SPDShow) s += " <color style='color:#666;'>[".concat((t.SPDShow * 100).toFixed(0), "%]</color>");
              return s;
            },
            class: 'monname',
            when: t.SPD
    ...
    if (lang == 'CH' && w.length == 1) wave_title = "<color style='font-weight:bold'>" + _monster[w[0].ID]['4'] + '</color>';
    var temp = {
      div: [{
        p: wave_title,
        class: 'wave_name'
