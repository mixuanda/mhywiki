$(function () {
  ...
  function popItem(v) {
    if (I_TYPE == '1' || I_TYPE == '2') popItem_1(v);else if (I_TYPE == '3' || I_TYPE == '4' || I_TYPE == '5') popItem_2(v);else popItem_3(v);
  }
      ...
      div: [{
        ...
        div: [{
          ...
          div: [{
            ...
            p: function (k) {
              return _skills[k.data].Desc.replaceAll('[b]', "<img class='sps' src='".concat(imgpre, "images/GCG_UI/")).replaceAll('[a]', ".png'>");
            }
          }, {
            div: function (k) {
                ...
                $(k.container).render({
                  div: [{
                    ...
                    div: {
                      ...
                      }, _ref[u].Desc.replaceAll('[b]', "<img class='sps' src='".concat(imgpre, "images/GCG_UI/")).replaceAll('[a]', ".png'>")],
                      class: 'c_p',
                      a: {
                        'data-id': _ref[u]._id
                      },
          ...
          div: [{
            ...
            div: [{
              div: [{
                ...
                div: this_item_2.Desc.replaceAll('[b]', "<img class='sps' src='".concat(imgpre, "images/GCG_UI/")).replaceAll('[a]', ".png'>"),
                class: 'weapon_story',
        ...
        div: {
          div: function (k) {
            this_K_remove_duplicate.forEach(function (u) {
              $(k.container).render({
                p: '<b>' + _keyword[u].Name.replaceAll('[b]', "<img class='sps' src='".concat(imgpre, "images/GCG_UI/")).replaceAll('[a]', ".png'>") + '</b><br>' + _keyword[u].Desc.replaceAll('[b]', "<img class='sps' src='".concat(imgpre, "images/GCG_UI/")).replaceAll('[a]', ".png'>"),
                class: 'c_p'
              });
            });
          },
          ...
          div: [{
            ...
            div: [{
              div: [{
                ...
                div: this_item.Desc.replaceAll('[b]', "<img class='sps' src='".concat(imgpre, "images/GCG_UI/")).replaceAll('[a]', ".png'>"),
                class: 'weapon_story',
  ...
  $('body').on('click', '.ref_card', function () {
    window.location.href = '/gi/gcg/' + $(this).attr('data-id');
  });
