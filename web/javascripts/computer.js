                                    ...
                                    template: {
                                        tr: [{
                                            td: [
                                                {
                                                    img: function (f) {
                                                        return `https://homdgcat.wiki/homdgcat-res/UI/${f.data}.png`.replaceAll('Phys', 'Physical')
                                                    },
                                                    datapath: '_id',
                                                    class: 'resicon'
                                                },
                ...
                event: {
                    click: function (p) {
                        ...
                        for (const pic of data.Csx) {
                            $(p.sender).render({
                                div: {
                                    img: `https://homdgcat.wiki/EnemyChart/${pic}.png`,
                                    style: {
                                        width: '100%',
                                    },
                                    event: {
                                        click: function (o) {
                                            window.open(`https://homdgcat.wiki/EnemyChart/${pic}.png`, '_blank')
                                        }
                                    },
                                },
                                class: 'csxylic',
