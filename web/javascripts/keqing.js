$(function () {
  ...
  Keqing_Data.forEach(function (t, i) {
      ...
      s.Data.forEach(function (z) {
        ...
        table_data.push({
          tr: [{
            ...
            td: {
              a: window.innerWidth > 500 ? "//www.bilibili.com/video/".concat(z.Vid) : "//player.bilibili.com/player.html?bvid=".concat(z.Vid),
              t: {
                span: '<u>' + z.Vid + '</u>',
                style: {
                  'color': '#eee'
    ...
    parts.push({
      div: [{
        p: "".concat(t.Ver, " ").concat(lang == 'CH' ? '幽境危战' : 'Stygian Onslaught'),
        class: 'name'
      }, {
        div: contents,
        class: 'card_content'
