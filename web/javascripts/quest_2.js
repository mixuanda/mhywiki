$(function () {
                ...
                div: [{
                  ...
                  p: function (k) {
                    ...
                    edited_linecount.forEach(function (t, i) {
                      ...
                      $(k.container).render({
                        span: function (k) {
                          return '<color style=\'color:#df903b\'>' + t.Name.toString().replaceAll('_0', "<img class='sps' src='".concat(imgpre, "images/Misc/Traveler").concat(mf.toString(), ".png'>")).replaceAll('_1005', "<img class='sps' src='".concat(imgpre, "images/Misc/Paimon.png'>")) + '</color> ' + t.Count;
                        },
                        class: 'tag_span'
                      });
                    });
  ...
  $('body').on('click', '.hover-shadow-', function (e) {
    ...
    if (_material[$(this).attr('data-id')].Type == '1') {
      window.location.href = "../char/".concat($(this).attr('data-id'));
      return;
    }
  ...
  function popItem(y) {
    ...
    if (this_item.Link) {
      window.location.href = "../item/".concat(this_item._id);
      return;
    }
    poplayer({
                    ...
                    if (_sq[m].Talk && _sq[m].Talk.length) {
                      _sq[m].Talk.forEach(function (i) {
                        ...
                        i.forEach(function (j) {
                          $(k.container).render({
                            p: '<b>' + j.N.toString().replaceAll('_0', "<img class='sps_4' src='".concat(imgpre, "images/Misc/Traveler").concat(mf.toString(), ".png'>")).replaceAll('_1005', "<img class='sps_4' src='".concat(imgpre, "images/Misc/Paimon.png'>")) + '</b><br>' + process(j.T).replaceAll('{NICKNAME}', "<img class='sps_4' src='".concat(imgpre, "images/Misc/Traveler").concat(mf.toString(), ".png'>")).replaceAll("#", "").replaceAll("\\n", "<br>")
                          });
                        });
                      });
                    }
