$(function () {
  ...
  $('h3 .lang').html(txt.Home_Lang.replaceAll("'>", "".concat(window.location.hash, "'>")));
  $('h3 .lang').hide();
  $('h3 .links').render([{
    ...
    $(n).render({
      template: {
        div: [{
          ...
          img: imgpre + "images/".concat(t.Figure),
          class: 'avatar-head',
          event: {
            error: function (d) {
              $(d.sender).hide();
        ...
        div: [{
          ...
          div: [{
            ...
            div: [{
              ...
              span: [lang == 'CH' ? '血量倍数（%）：' : 'HP Multiplier (%): ', {
                input: '',
                a: {
                  type: 'text',
                  id: 'hp_mult',
  ...
  function renderSkill(cur_mon) {
    ...
    sk.forEach(function (skid) {
      ...
      $('.mon_body_').render({
        template: {
          div: [{
            div: [(skill.Threat ? "<color style='color:#f29e38;font-weight:normal;'>⚠ </color>" : '') + skill.Name, {
              span: [{
            ...
            div: [{
              ...
              p: '[ ' + (skill.S ? (skill.S.toString() + ' ').replaceAll(",", " , ").replaceAll(".0 ", " ") : "") + ' ]<br>' + skill.K,
              class: 'phase',
  ...
  function refreshStats() {
    ...
    if (!_hardlevelgroup[HLG]) {
      HLG = 1;
    }
    if (!_hardlevelgroup[HLG][LV - 1]) {
      LV = _hardlevelgroup[HLG].length;
    }
  }
  ...
  $('body').on('click', '.up', function () {
    if (LV == 100) LV = 120;else if (LV == 120) {} else LV++;
    $('.base_stat_lv').val(LV);
    renderStat(cm);
  });
  $('body').on('click', '.down', function () {
    if (LV == 120) LV = 100;else LV--;
    $('.base_stat_lv').val(LV);
    renderStat(cm);
  });
