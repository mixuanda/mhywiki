                                                ...
                                                },
                                                {
                                                    p: function (k) {
                                                        ...
                                                        _line_count.forEach(function (t, i) {
                                                            ...
                                                            $(k.container).render({
                                                                span: function (k) {
                                                                    return '<color style=\'color:#df903b\'>' + t.Name.toString().replaceAll('_0', `<img class='sps' src='https://homdgcat.wiki/images/Misc/Traveler${mf.toString()}.png'>`).replaceAll('_1005', `<img class='sps' src='https://homdgcat.wiki/images/Misc/Paimon.png'>`) + '</color> ' + t.Count
                                                                },
                                                                class: 'tag_span'
                                                            })
                                                        })
                                                    ...
                                                    m.Talks.forEach(function (i) {
                                                        if (_talks[i] && _talks[i].length) {
                                                            ...
                                                            _talks[i].forEach(function (j) {
                                                                if (j.N) {
                                                                    $(k.container).render({
                                                                        p: '<b>' + j.N.toString().replaceAll('_0', `<img class='sps_4' src='https://homdgcat.wiki/images/Misc/Traveler${mf.toString()}.png'>`).replaceAll('_1005', `<img class='sps_4' src='https://homdgcat.wiki/images/Misc/Paimon.png'>`) + '</b><br>' + process(j.T).replaceAll('{NICKNAME}', `<img class='sps_4' src='https://homdgcat.wiki/images/Misc/Traveler${mf.toString()}.png'>`).replaceAll("#", "").replaceAll("\\n", "<br>")
                                                                    })
                                                                } else {
                                                                    $(k.container).render({
                                                                        p: process(j.T).replaceAll('{NICKNAME}', `<img class='sps_4' src='https://homdgcat.wiki/images/Misc/Traveler${mf.toString()}.png'>`).replaceAll("#", "").replaceAll("\\n", "<br>"),
                                                                        style: {
                                                                            color: '#FFD780',
                                                                            //'font-weight': 'bold'
                                                                        }
