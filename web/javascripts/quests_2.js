$(function () {
  ...
  function begin() {
            ...
            div: [{
              ...
              div: [{
                div: [{
                  ...
                  p: _chapter_info.Title ? _chapter_info.Title : "ID ".concat(_chapter_info._id),
                  style: {
                    'font-weight': 'bold',
                    'text-align': 'center',
                    'font-size': '1.5em'
    ...
    _quest_list.forEach(function (t, ind) {
      $('.content_flag').render({
        div: [{
          p: t.Name ? t.Name : "ID ".concat(t._id),
          class: 'event-name'
        }, {
          p: t.Desc,
          class: 'event-desc'
  ...
  function popTalks(dat_id, dat_ind) {
    poplayer_([{
      div: function (l) {
        ...
        $(l.container).render({
          div: [{
            p: _QUE.Name ? _QUE.Name : "ID ".concat(_QUE._id),
            class: 'event-name'
          }, {
            p: _QUE.Desc,
            class: 'event-desc'
  ...
  function returnMain() {
    ...
    $('h3 .tlsub').html("<a class='translate_' href='?lang=CH".concat(window.location.hash, "'><b>\u4E2D\u6587</b></a> | <a class='translate_' href='?lang=EN").concat(window.location.hash, "'><b>English</b></a> | <a class='translate_' href='?lang=JP").concat(window.location.hash, "'><b>\u65E5\u672C\u8A9E</b></a> | <a class='translate_' href='?lang=KR").concat(window.location.hash, "'><b>\uD55C\uAD6D\uC778</b></a>"));
  }
