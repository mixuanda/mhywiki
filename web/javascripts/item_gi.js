$(function () {
  ...
  function renderItems() {
    ...
    _items[parseInt(I_TYPE)].forEach(function (t, i) {
      $('.area').render({
        ...
        style: {
          'background-image': "linear-gradient(180deg, ".concat(rarity_color[t.R], ", #fff)")
        },
        a: {
          'data-id': i + 1
        }
  ...
  function returnMain() {
    ...
    $('h3 .tlsub').html("<a class='translate_' href='?lang=CH".concat(window.location.hash, "'><b>\u4E2D\u6587</b></a> | <a class='translate_' href='?lang=EN").concat(window.location.hash, "'><b>English</b></a> | <a class='translate_' href='?lang=JP").concat(window.location.hash, "'><b>\u65E5\u672C\u8A9E</b></a> | <a class='translate_' href='?lang=KR").concat(window.location.hash, "'><b>\uD55C\uAD6D\uC778</b></a> | <a class='translate_' href='?lang=RU").concat(window.location.hash, "'><b>\u0420\u0443\u0441\u0441\u043A\u0438\u0439</b></a>"));
  }
  function update() {
  ...
  $('body').on('click', '.item-jump', function () {
    window.location.href = "/gi/item/".concat($(this).attr('data-id'));
  });
  $('body').on('click', '.avatar-jump', function () {
    window.location.href = "/gi/char/".concat($(this).attr('data-id'));
  });
});