$(function () {
  ...
  cur_coordinate = 0;
  $('h3 .lang').html("<a class='translate_' href='?lang=CH".concat(window.location.hash, "'><b>\u4E2D\u6587</b></a> | <a class='translate_' href='?lang=EN").concat(window.location.hash, "'><b>English</b></a> | <a class='translate_' href='?lang=JP").concat(window.location.hash, "'><b>\u65E5\u672C\u8A9E</b></a> | <a class='translate_' href='?lang=KR").concat(window.location.hash, "'><b>\uD55C\uAD6D\uC778</b></a>"));
  ...
  if (lang == 'EN') {
    ...
    $('body').css('font-family', "'Microsoft YaHei', sans-serif");
  }
  ...
  var _yes = '✔';
  var _no = '';
  var exp = [112510, 177910, 206920, 389390, 822140, 1326050, 2763000];
  var emote_num = 23;
  ...
  function cntd() {
    ...
    $('.c2_a').html(lang == 'CH' ? "\u4E91\u7483 : <b>".concat(age_d, "</b> \u5929") : "Yunli: <b>".concat(age_d, "</b> days old"));
    if (anniversary) {
    ...
    div: {
      div: [{
        ...
        div: [{
          ...
          p: {
            CH: '<a href="https://yuhengcup.wiki" target="_blank">yuhengcup.wiki</a> | <a href="https://space.bilibili.com/3546567522912510" target="_blank">b站@妮可少女</a>',
            EN: '<a href="https://homdgcat.wiki" target="_blank">homdgcat.wiki</a> | <a href="http://t.me/homdgcat" target="_blank">t.me/homdgcat</a>'
          }[lang],
          class: 'as_left_name'
        }],
        class: 'as_right_2'
  ...
  var vid_show = 0;
  if (lang == 'CH') {
    fetch('/Char/HSR.json').then(x => x.json()).then(y => {
      pic_index = y;
      if (check_pic_dl()) {
  ...
  function renderCL(v) {
    ...
    $('.cl_data').render({
      div: {
        ...
        click: function (l) {
          download("/Char/HSR/".concat(change_filename, "/").concat(VER_SR, ".png"), "".concat(VER_SR, " ").concat(change_filename));
        },
        style: {
          width: 'max-content',
          padding: '10px 20px',
      ...
      $('.cl_data').render({
        div: [{
          div: [{
            ...
            p: t.Name + "<span id='3_".concat(j, "' style='white-space:pre;'></span>"),
            style: {
              'margin-left': '10px'
            },
        ...
        class: 'a_section_skill'
      });
      $("#3_".concat(j)).html(plus(t.Changes ? t.Changes.length : t.Num));
    });
    _diff_weapon.forEach(function (i, j) {
      ...
      $('.cl_data').render({
        div: [{
          div: [{
            img: imgpre + "images/lightconemediumicon/".concat(ticon),
            class: 'head_left_',
            style: {
              width: 'auto'
            },
            ...
            p: tname + "<span id='2_".concat(j, "' style='white-space:pre;'></span>"),
            style: {
              'margin-left': '10px'
            },
            class: 'head_right hr_0'
      ...
      $("#2_".concat(j)).html(plus(shows.length));
    });
    _diff_avatar.forEach(function (i, j) {
      ...
      $('.cl_data').render({
        div: [{
          div: [{
            img: imgpre + "images/".concat(ticon, ".png"),
            class: 'head_left_',
            style: {
              width: 'auto'
            },
            ...
            p: tname + "<span id='1_".concat(j, "' style='white-space:pre;'></span>"),
            style: {
      ...
      $("#1_".concat(j)).html(plus(shows.length));
    });
    var added = _changelog_veradd[vn] ? _changelog_veradd[vn] : [];
    added.forEach(function (t, j) {
  ...
  function ver_addfunction(t, j) {
    ...
    if (!t._id) {
      ...
      $("#3_".concat(j)).html(plus(t.Notes.length));
    } else {
      $('.cl_data').render({
        div: [{
          div: [{
            ...
            p: t.Name + "<span id='4_".concat(j, "' style='white-space:pre;'></span>"),
            style: {
              'margin-left': '10px'
            },
            class: 'head_right hr_0'
          ...
          div: [{
            ...
            p: t.HP ? "<img src=\"".concat(imgpre + 'images/Misc/_HPBIG.png', "\" class=\"climg_\"> <b>") + t.HP[0] + "</b> <color style='color:#f29e38'><color style=\"margin-left:5px;margin-right:5px\">\u2192</color></color> <b>" + t.HP[1] + '</b>' : '',
            style: {
              'margin-top': '5px'
            },
            when: t.HP
          }, {
            p: t.SPD ? "<img src=\"".concat(imgpre + 'images/Misc/_SPDBIG.png', "\" class=\"climg_\"> <b>") + (t.SPD[0] * 1.2).toFixed(0) + "</b> <color style='color:#f29e38'><color style=\"margin-left:5px;margin-right:5px\">\u2192</color></color> <b>" + (t.SPD[1] * 1.2).toFixed(0) + '</b><color style="margin-left:8px">(Lv82)</color>' : '',
            style: {
              'margin-top': '5px'
            },
            when: t.SPD && t.Rank == 1
          }, {
            p: t.SPD ? "<img src=\"".concat(imgpre + 'images/Misc/_SPDBIG.png', "\" class=\"climg_\"> <b>") + (t.SPD[0] * 1.32).toFixed(0) + "</b> <color style='color:#f29e38'><color style=\"margin-left:5px;margin-right:5px\">\u2192</color></color> <b>" + (t.SPD[1] * 1.32).toFixed(0) + '</b><color style="margin-left:8px">(Lv95)</color>' : '',
            style: {
              'margin-top': '5px'
            },
            when: t.SPD && t.Rank != 0
            ...
            p: function (o) {
              ...
              t.Stance[0][1].forEach(function (s) {
                out_o += "<img src=\"".concat(imgpre, "images/Element/").concat(s, ".png\" class=\"climg_\">");
              });
              out_o += ' <b>' + (t.Stance[0][0] * 10).toFixed(0) + '</b> ';
              var out_n = "";
              t.Stance[1][1].forEach(function (s) {
                out_n += "<img src=\"".concat(imgpre, "images/Element/").concat(s, ".png\" class=\"climg_\">");
              });
  ...
  function d_avatar(av_data, vo, vn) {
    ...
    for (it in skill_list) {
      ...
      if (obp != nbp) {
        this_contents += "<br><img src=\"".concat(imgpre + 'images/Misc/PointBPFull.png', "\" class=\"climg\">") + (obp >= 0 ? '+' + obp : obp) + " @<color style=\"margin-left:5px;margin-right:5px\">\u2192</color># <img src=\"".concat(imgpre + 'images/Misc/PointBPFull.png', "\" class=\"climg\">") + (nbp >= 0 ? '+' + nbp : nbp);
      }
      var ospa = oo.SPAdd ? oo.SPAdd : 0;
      var nspa = nn.SPAdd ? nn.SPAdd : 0;
      if (ospa != nspa) {
        this_contents += "<br><img src=\"".concat(imgpre + 'images/AddProp/IconEnergyRecovery.png', "\" class=\"climg\">") + (ospa >= 0 ? '+' + ospa : ospa) + " @<color style=\"margin-left:5px;margin-right:5px\">\u2192</color># <img src=\"".concat(imgpre + 'images/AddProp/IconEnergyRecovery.png', "\" class=\"climg\">") + (nspa >= 0 ? '+' + nspa : nspa);
      }
      var ospn = oo.SPNeed ? oo.SPNeed : 0;
      var nspn = nn.SPNeed ? nn.SPNeed : 0;
      if (ospn != nspn) {
        this_contents += "<br><img src=\"".concat(imgpre + 'images/AddProp/IconEnergyLimit.png', "\" class=\"climg\">") + ospn + " @<color style=\"margin-left:5px;margin-right:5px\">\u2192</color># <img src=\"".concat(imgpre + 'images/AddProp/IconEnergyLimit.png', "\" class=\"climg\">") + nspn;
      }
      var ost = av_skill_stance(av_data, oo);
      var nst = av_skill_stance(av_data, nn);
      if (ost != nst) {
        this_contents += "<br><img src=\"".concat(imgpre, "images/Element/").concat(av_data.Element, ".png\" class=\"climg_\">") + ost + " @<color style=\"margin-left:5px;margin-right:5px\">\u2192</color># <img src=\"".concat(imgpre, "images/Element/").concat(av_data.Element, ".png\" class=\"climg_\">") + nst;
      }
  ...
  function av_skilltree_addprop(addprops) {
    ...
    for (const [p, x] of Object.entries(addprops)) {
      ...
      out += "<img src='".concat(imgpre, "images/AddProp/").concat(_propiconname[p], "' class='climg' style='margin-left:0;margin-right:-5px'> ").concat(xshow);
    }
    return out;
  }
  ...
  function renderHN() {
    ...
    for (const [i, t] of Object.entries(_changelog2)) {
      ...
      $('.hn_data').render({
        div: [{
          div: [{
            img: imgpre + "images/Paths/".concat(ticon, ".png"),
            class: 'head_left_',
            a: {
              loading: lazy
            }
          }, {
            p: tname + "<span style='white-space:pre;'>".concat(plus(t.length), "</span>"),
            style: {
              color: tcolor ? '#' + elemcolor[tcolor] : '',
              'margin-left': '10px'
            },
    ...
    _bossguide.forEach(function (t, i) {
      ...
      t.Notes.forEach(function (note) {
        ...
        if (note.Title && note.Title.length) {
          descs.push("<color style=\"color:$ffd780\"><b>".concat(note.Title, "</b></color>"));
        }
      ...
      $('.area').render({
        template: {
          div: [{
            ...
            img: no_skillicon.includes(t._id) ? imgpre + "images/avatarshopicon/999.png" : imgpre + "images/".concat(t.Icon.replaceAll('/Avatar/', '/avatar/'), ".png"),
            class: 'avatar-head',
            event: {
              error: function (d) {
                $(d.sender).remove();
            ...
            div: {
              img: no_skillicon.includes(t._id) ? imgpre + "images/avataricon/avatar/999.png" : imgpre + "images/".concat(t.Icon.replaceAll('/Avatar/', '/avatar/').replaceAll('avatarshopicon', 'avataricon'), ".png")
            },
      ...
      $('.area').render({
        template: {
          div: [{
            ...
            img: imgpre + "images/lightconemediumicon/".concat(t.Pic),
            class: 'weapon-head',
            event: {
              error: function (d) {
                $(d.sender).remove();
  ...
  $('body').on('click', '.weapon-rarity schedule', function () {
    ...
    $(".weapon-rarity schedule[data-id=".concat(global_var_weapon_rarity, "]")).addClass('active');
  });
  $('body').on('click', '.avatar-rarity schedule', function () {
    ...
    $(".avatar-rarity schedule[data-id=".concat(global_var_avatar_rarity, "]")).addClass('active');
  });
  ...
  function update_avatar() {
    ...
    var query_string = ".avatar-card-avatar[data-rarity=".concat(global_var_avatar_rarity, "]");
    var query_list_1 = [];
    for (const [a, b] of Object.entries(global_var_avatar_element)) {
      if (b) query_list_1.push("[data-elem='".concat(a, "']"));
    }
    if (!query_list_1.length) query_list_1.push('');
    var query_list_2 = [];
    for (const [a, b] of Object.entries(global_var_type)) {
      if (b) query_list_2.push("[data-type='".concat(a, "']"));
    }
    if (!query_list_2.length) query_list_2.push('');
    for (const a of query_list_1) {
      for (const b of query_list_2) {
        $("".concat(query_string).concat(a).concat(b)).show();
      }
    }
  }
  function update_weapon() {
    $('.avatar-card-weapon').hide();
    var query_string = ".avatar-card-weapon[data-rarity=".concat(global_var_weapon_rarity, "]");
    var query_list_2 = [];
    for (const [a, b] of Object.entries(global_var_type)) {
      if (b) query_list_2.push("[data-type='".concat(a, "']"));
    }
    if (!query_list_2.length) query_list_2.push('');
    for (const b of query_list_2) {
      $("".concat(query_string).concat(b)).show();
    }
  }
  ...
  function renderAvatarAfter(i) {
      ...
      $('.mon_body').render([{
        div: [{
          div: [{
            div: [{
              div: {
                img: no_skillicon.includes(this_avatar._id) ? imgpre + "images/avataricon/avatar/999.png" : imgpre + "images/".concat(this_avatar.Icon.replaceAll('/Avatar/', '/avatar/').replaceAll('avatarshopicon', 'avataricon'), ".png"),
                event: {
                  error: function (d) {
                    $('.as_left').remove();
                  }
            ...
            div: {
              ...
              class: 'hover-shadow',
              click: function () {
                download("/Char/HSR/".concat(this_avatar.Name, "/").concat(VER_SR, ".png"), "".concat(VER_SR, " ").concat(this_avatar.Name));
              }
            },
            style: {
              width: '100%',
    ...
    if (i == 3 || i == 10) {
      ...
      skill_list.forEach(function (s, i) {
        ...
        $('.mon_body').render({
          ...
          class: 'a_section_skill ' + (_servant_skills.includes(s) ? 'c_0 c_1' : 'c_0 c_2')
        });
      });
      $('.mon_body').render(emote_block);
    }
    if (i == 4 || i == 3 || i == 10) {
      ...
      $('.mon_body').render([{
        ...
        class: 'a_section_skill c_0 c_2 tree4',
        when: show_4
      }]);
      $('.mon_body').render(emote_block);
        ...
        $('.mon_body').render({
          div: [{
            ...
            div: {
              ...
              data: ["<b>".concat(vo, " @\u2192# ").concat(vn, "<b>")].concat(shows_1, d_avatar(this_avatar, vo, vn)),
              style: {
                'margin-top': '20px'
              }
            },
        ...
        div: [{
          div: [{
            ...
            div: {
              ...
              class: 'hover-shadow',
              click: function () {
                download("/Char/HSR/".concat(this_avatar.Name, "/").concat(VER_SR, ".png"), "".concat(this_avatar.Ver, " ").concat(this_avatar.Name));
              }
            },
            style: {
              width: '100%',
          ...
          div: function (k) {
            t.V.forEach(function (u) {
              $(k.container).render({
                ...
                click: function (l) {
                  download("/Char/HSR/".concat(t.N, "/").concat(u, ".png"), "".concat(u, " ").concat(t.N));
                }
              });
            });
          },
  ...
  function ppics(txt) {
    return txt.replaceAll("- HP", "<span class='sbp'><img src='".concat(imgpre, "images/Misc/_HP.png'>")).replaceAll("- ATK", "<span class='sbp'><img src='".concat(imgpre, "images/Misc/_ATK.png'>")).replaceAll("- DEF", "<span class='sbp'><img src='".concat(imgpre, "images/Misc/_DEF.png'>")).replaceAll("- SPD", "<span class='sbp'><img src='".concat(imgpre, "images/Misc/_SPD.png'>")).replaceAll("- Energy", "<span class='sbp'><img src='".concat(imgpre, "images/Misc/_ENERGY.png'>")).replaceAll(" ;", "</span>").replaceAll("- 生命值", "<span class='sbp'><img src='".concat(imgpre, "images/Misc/_HP.png'>")).replaceAll("- 攻击力", "<span class='sbp'><img src='".concat(imgpre, "images/Misc/_ATK.png'>")).replaceAll("- 防御力", "<span class='sbp'><img src='".concat(imgpre, "images/Misc/_DEF.png'>")).replaceAll("- 速度", "<span class='sbp'><img src='".concat(imgpre, "images/Misc/_SPD.png'>")).replaceAll("- 能量上限", "<span class='sbp'><img src='".concat(imgpre, "images/Misc/_ENERGY.png'>")).replaceAll("- 能量", "<span class='sbp'><img src='".concat(imgpre, "images/Misc/_ENERGY.png'>"));
  }
