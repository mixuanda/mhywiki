$(function () {
    ...
    if (anniversary && div2 == '.c1_a') {
      if (now >= keqing_birthday) {
        ...
        if (age_s == 0) {
          ...
          $(div2).html({
            CH: "".concat(char_name, "\u751F\u65E5 : <b><color style='color:#DD0000'>").concat(age_s, "</color></b> \u5929\u524D"),
            EN: "".concat(char_name, "'s birthday: <b><color style='color:#DD0000'>").concat(age_s, "</color></b> days ago")
          }[lang]);
        }
      } else {
        var age_s = parseInt((keqing_birthday - now) / 86400000);
        $(div2).html({
          CH: "".concat(char_name, "\u751F\u65E5 : <b><color style='color:#DD0000'>").concat(age_s, "</color></b> \u5929\u540E"),
          EN: "".concat(char_name, "'s birthday: In <b><color style='color:#DD0000'>").concat(age_s, "</color></b> days")
        }[lang]);
      }
    } else {
      $(div2).html(lang == 'CH' ? "".concat(char_name, " : <b>").concat(age_d, "</b> \u5929") : "".concat(char_name, ": <b>").concat(age_d, "</b> days old"));
    }
    if (a == 0) {
  ...
  function start_fntd(start_timestamp, time_list, output_table, offset, birthday_stamp, birthday_image, char_name) {
    ...
    $(output_table + '_2').render({
      p: lang == 'CH' ? "".concat(char_name, " : <b>").concat(age_d, "</b> \u5929") : "".concat(char_name, ": <b>").concat(age_d, "</b> days old")
    });
    var data_list = [];
    ...
    div: [{
      ...
      section: {
        ...
        t: [{
          ...
          p: "[[Name/".concat(lang3, "]]").concat(meow),
          class: 'new_text',
          style: {
            color: function (d) {
      ...
      section: {
        ...
        t: [{
          ...
          p: "[[Name/".concat(lang3 == 'RU' ? 'EN' : lang3, "]]").concat(meow2),
          class: 'new_text',
          style: {
            color: function (d) {
              return d.data.Rarity == 5 ? '#df903b' : '#ffacff';
