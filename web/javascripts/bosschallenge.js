$(function () {
  ...
  var time = ["", "10min", "10min", "Lv90 10min", "Lv100 120s", "Lv105 120s", lang == 'CH' ? 'Lv110 共享 180s' : 'Lv110 Share 180s', ""];
          ...
          h4: [{
            ...
            div: [{
              ...
              click: function () {
                ...
                download("/Abyss/".concat(lang, "/-").concat(phase_data.Ver, ".png"), "".concat(phase_data.Ver, " ").concat(content_title_name[lang]));
              }
            }, {
              div: [{
                div: {
    ...
    level_data.Monsters.forEach(function (t_id, i) {
      ...
      $('.mon_info_' + i).empty().render({
        template: [{
          ...
          div: {
            p: function (k) {
              var ret = "<a href='".concat(link_1, "' class='hp_a' target='_blank'>") + t.HP + '</a>' + (t.HPCount ? "\xD7".concat(t.HPCount) : '');
              if (t.HP_2 != undefined && t.HP_2 != 0) {
                ret += " / <a href='".concat(link_2, "' class='hp_a' target='_blank'>") + t.HP_2 + '</a>' + (t.HPCount ? "\xD7".concat(t.HPCount) : '');
              }
              return ret;
            },
            class: 'desc_hp',
  ...
  $('body').on('click', '.sw_but', function () {
    ...
    $(".sw_".concat(but_id, "_1")).toggle();
    $(".sw_".concat(but_id, "_2")).toggle();
  });
