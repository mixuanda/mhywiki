$(function () {
  ...
  skill_or_talent = 0;
  o = 0;
  var exp = [120175, 578325, 579100, 854125, 1195925, 1611875, 3423125];
  var this_ver_ = "";
  var ou1;
  var ou2;
  var showtop = 0;
  ...
  var pic_show = 0;
  if (lang == 'CH') {
    fetch('/Char/GI.json').then(x => x.json()).then(y => {
      pic_index = y;
      if (check_pic_dl()) {
    ...
    if (anniversary) {
      ...
      if (birthday_difference < 0) {
        ...
        if (birthday_days == 0) {
          ...
          $('.c1_a').html({
            CH: "\u523B\u6674\u751F\u65E5 : <b><color style='color:#DD0000'>".concat(birthday_days, "</color></b> \u5929\u524D"),
            EN: "Keqing's birthday: <b><color style='color:#DD0000'>".concat(birthday_days, "</color></b> days ago")
          }[lang]);
        }
      }
    }
    if (!written) $('.c1_a').html(lang == 'CH' ? "\u523B\u6674 : <b>".concat(age_d, "</b> \u5929") : "Keqing: <b>".concat(age_d, "</b> days old"));
    if (countdown_time == 0) {
  ...
  function startAvatar(p) {
    ...
    if (!loaded_a_1.includes(cur_avatar_name)) {
      ...
      script_computer_2.src = "/gi/".concat(lang3, "/Avatar/").concat(cur_avatar_name, "_1.js");
      ...
      script_computer_2.onload = function () {
        ...
        if (!loaded_a_2.includes(cur_avatar_name)) {
          ...
          script_computer_3.src = "/gi/".concat(lang3, "/Avatar/").concat(cur_avatar_name, "_2.js");
            ...
            div: [{
              div: [{
                ...
                div: {
                  ...
                  class: 'hover-shadow',
                  click: function () {
                    download("/Char/GI/".concat(cur_avatar.Name, "/").concat(VER_GI, ".png"), "".concat(cur_avatar.Version, " ").concat(cur_avatar.Name));
                  }
                },
                style: {
                  width: '100%',
      ...
      if (clv.length) {
        ...
        need_render.forEach(function (w) {
          $('.a_data').render({
            div: [{
              div: [{
                img: imgpre + "homdgcat-res/Avatar/UI_AvatarIcon_".concat(avatar_name_temp, ".png"),
                class: 'head_left',
                event: {
                  error: function (d) {
                    $(d.sender).hide();
  ...
  function renderTemplate(avatar, type) {
    ...
    var temp_2 = {
      div: [{
        div: {
          div: [{
            div: {
              img: imgpre + "homdgcat-res/Avatar/".concat(this_avatar.Icon, ".png"),
              event: {
                error: function (d) {
                  $('.as_left').remove();
                }
      ...
      }, avatar_stat_show_0, avatar_stat_show, avatar_stat_show_2],
      class: 'a_section',
      style: type == "Passives Constellations" ? {
        'padding-bottom': '30px',
        'padding-top': '10px'
    ...
    if (type == "Basic Info") {
                  ...
                  if (loaded_a_2.includes(this_avatar._name)) {
                    if (_AvatarCostumeConfig[this_avatar._id].Dish.Name.length) {
                      ...
                      $(d.container).empty().render({
                        ...
                        event: {
                          click: function () {
                            window.location.href = "/gi/item/".concat(dish.JD);
                          }
                        },
                        style: {
                          cursor: 'pointer'
      ...
      dr = {
          ...
          div: {
            div: [{
              ...
              div: {
                ...
                class: 'hover-shadow',
                click: function () {
                  download("/Char/GI/".concat(this_avatar.Name, "/").concat(VER_GI, ".png"), "".concat(VER_GI, " ").concat(this_avatar.Name));
                }
              },
              style: {
                width: '100%',
        ...
        "Passive Skills": [global_var_avatar_hex ? '' : emote_block, {
          div: [{
            div: [{
              img: function (k) {
                if (anniversary && this_avatar._id == 42) return '/homdgcat-res/UI/birthday-cake2.png';
          ...
          class: 'a_section_skill shows shows_2',
          data: use_PassiveSkills
        }],
        "Constellations": [global_var_avatar_hex ? '' : emote_block, {
          div: [{
            div: [{
              img: function (k) {
                if (anniversary && this_avatar._id == 42) return '/homdgcat-res/UI/birthday-cake2.png';
          ...
          class: 'a_section_skill shows shows_3',
      ...
      var initial = [temp_2, emote_block, {
        div: [{
  ...
  function renderHN() {
    ...
    _NA.forEach(function (u) {
      if (!loaded_a_1.includes(u)) {
        let script_computer_2 = document.createElement('script');
        script_computer_2.src = "/gi/".concat(lang3, "/Avatar/").concat(u, "_1.js");
        document.head.append(script_computer_2);
        script_computer_2.onload = function () {
          _AvatarDataConfig = {
            ..._AvatarDataConfig,
      ...
      $('.hd_data').render({
        div: [{
          div: [{
            ...
            p: u.Date + '<br><color style="color:#FFD780;">' + (lang == 'CH' ? '妮可少女 玉衡杯数据库 yuhengcup.wiki <b>' : 'homdgcat.wiki | t.me/homdgcat <b>') + (lang == 'CH' ? u.Ver.replaceAll('Live', '正式服') : u.Ver) + '</b></color>',
            style: {
              'font-size': '0.8em',
              'font-weight': 'normal',
              'text-align': 'center',
      ...
      $('.boss_data').render({
        div: [{
          div: [{
            ...
            p: '<color style="color:#FFACFF;">' + (lang == 'CH' ? '妮可少女 玉衡杯数据库 yuhengcup.wiki <b>' : 'homdgcat.wiki | t.me/homdgcat <b>') + '</b></color>',
            style: {
              'font-size': '0.8em',
              'font-weight': 'normal',
              'text-align': 'center',
          ...
          div: function (k) {
            t.V.forEach(function (u) {
              $(k.container).render({
                ...
                click: function (l) {
                  download("/Char/GI/".concat(t.N, "/").concat(u, ".png"), "".concat(u, " ").concat(t.N));
                }
              });
            });
          },
  ...
  function renderCL(v) {
    ...
    $('.cl_data').render({
      div: {
        ...
        click: function (l) {
          download("/Char/GI/".concat(change_filename, "/").concat(VER_GI, ".png"), "".concat(VER_GI, " ").concat(change_filename));
        },
        style: {
          width: 'max-content',
          padding: '10px 20px',
    ...
    _NW.forEach(function (u) {
      if (!loaded_w.includes(u)) {
        let script_computer_2 = document.createElement('script');
        script_computer_2.src = "/gi/".concat(lang3, "/Weapon/").concat(u, ".js");
        document.head.append(script_computer_2);
        script_computer_2.onload = function () {
          _WeaponAffixPConfig = {
            ..._WeaponAffixPConfig,
            ..._WeaponAffixPConfig_
          };
          weapon_story_cache = {
            ...weapon_story_cache,
            ...weapon_story_cache_
      ...
      if (_relic_changelog[v2_ver] && _relic_changelog[v2_ver].length) {
        _relic_changelog[v2_ver].forEach(function (t) {
          $('.cl_data').render({
            div: [{
              div: [{
                img: imgpre + "homdgcat-res/Relic/".concat(t.Icon, "_4.png"),
                class: 'head_left',
                event: {
                  error: function (d) {
                    $(d.sender).hide();
              ...
              div: function (s) {
                t.Changes.forEach(function (y) {
                  ...
                  if (const_change.length) {
                    $(s.container).render({
                      p: "<b><color style='color:#FFD780'>[".concat(y.Num, "]</color></b><br>") + const_change
                    });
                  }
                });
              },
  ...
  function cl_write_weapon(v, v1, v2) {
    ...
    if (desc_change.length || show_others) {
      $('.cl_data').render({
        div: [{
          div: [{
            img: imgpre + "homdgcat-res/Weapon/".concat(o_this.Icons, "_Awaken.png"),
            class: 'head_left',
            event: {
              error: function (d) {
                $(d.sender).hide();
    ...
    $('.hn_data').render({
      div: [{
        div: [{
          ...
          p: "<color style='color:".concat(colors[o_this.Element], "'>") + o_this.Name + '</color>' + (_AvatarDataConfig[u].OtherDataList.length ? '<span style="font-size:0.87em">+' + _AvatarDataConfig[u].OtherDataList.length + '</span>' : ''),
          class: 'head_right hr_1'
        }],
        class: 'a_section_head head_withimg'
      }, {
  ...
  function doRelic(cr) {
    ...
    cur_relic = cr;
    let script_computer_2 = document.createElement('script');
    script_computer_2.src = "/gi/".concat(lang3, "/Relic/").concat(cur_relic.ID, ".js");
    document.head.append(script_computer_2);
    script_computer_2.onload = function () {
      relic_story_cache = {
        ...relic_story_cache,
    ...
    _WeaponConfig.forEach(function (wpn) {
      $('.avatar-area-weapon-reserved').render({
        div: [{
          img: function (k) {
            rlname = k.data.Icons;
            return imgpre + "homdgcat-res/Weapon/".concat(rlname, "_Awaken.png");
          },
          class: 'avatar-head',
          event: {
            error: function (d) {
  ...
  function update_avatar() {
    ...
    var query_string = global_var_avatar_hex ? '' : ".avatar-card-mark[data-rarity=".concat(global_var_avatar_rarity, "]");
    ...
    for (const a of query_list_1) {
      for (const b of query_list_2) {
        $("".concat(query_string).concat(a).concat(b).concat(hex_flag)).show();
      }
    }
  }
  function update_weapon() {
    $('.avatar-card').hide();
    $(".avatar-card[data-type=".concat(global_var_weapon_type, "][data-rarity=").concat(global_var_weapon_rarity, "]")).show();
  }
  function renderWeaponInfo(wpn) {
    ...
    if (!loaded_w.includes(wpn._id)) {
      let script_computer_2 = document.createElement('script');
      script_computer_2.src = "/gi/".concat(lang3, "/Weapon/").concat(wpn._id, ".js");
      document.head.append(script_computer_2);
      script_computer_2.onload = function () {
        _WeaponAffixPConfig = {
          ..._WeaponAffixPConfig,
  ...
  $('body').on('click', '.weapon-type schedule', function () {
    ...
    $(".weapon-type schedule[data-id=".concat(global_var_weapon_type, "]")).addClass('active');
  });
    ...
    if (_awc[v2]) {
      if (_awc[v2][codename]) {
        ...
        out.push({
          ...
          "V": "<span class='addprop' style='margin-right:-2px'><img src='".concat(imgpre, "homdgcat-res/Abyss/_HP.png'></span><span style='margin-right: 10px'>").concat(_awc[v2][codename].Old.ShowStats.HP, "</span>") + "<span class='addprop' style='margin-right:-2px'><img src='".concat(imgpre, "homdgcat-res/Abyss/_ATK.png'></span><span style='margin-right: 10px'>").concat(_awc[v2][codename].Old.ShowStats.ATK, "</span>") + "<span class='addprop' style='margin-right:-2px'><img src='".concat(imgpre, "homdgcat-res/Abyss/_DEF.png'></span><span style='margin-right: 10px'>").concat(_awc[v2][codename].Old.ShowStats.DEF, "</span>") + "<span>".concat(old_p_name, " +").concat(_awc[v2][codename].Old.ShowStats.Custom, "</span>") + "<color style='color:#FFD780'><br><span style='margin-left: 10px'>↓↓</span><br></color><span style='position:relative;top:-10px;'>" + "<span class='addprop' style='margin-right:-2px'><img src='".concat(imgpre, "homdgcat-res/Abyss/_HP.png'></span><span style='margin-right: 10px'>").concat(_awc[v2][codename].New.ShowStats.HP, "</span>") + "<span class='addprop' style='margin-right:-2px'><img src='".concat(imgpre, "homdgcat-res/Abyss/_ATK.png'></span><span style='margin-right: 10px'>").concat(_awc[v2][codename].New.ShowStats.ATK, "</span>") + "<span class='addprop' style='margin-right:-2px'><img src='".concat(imgpre, "homdgcat-res/Abyss/_DEF.png'></span><span style='margin-right: 10px'>").concat(_awc[v2][codename].New.ShowStats.DEF, "</span>") + "<span>".concat(new_p_name, " +").concat(_awc[v2][codename].New.ShowStats.Custom, "</span></span>")
        });
      }
    }
