        ...
        p.Mats.forEach(function (grp) {
            ...
            grp.forEach(function (item_data) {
                var outs = {
                    ...
                    t: [
                        {
                            img: `https://homdgcat.wiki/homdgcat-res/Mat/UI_ItemIcon_${item_data.ID}.png`,
                            class: 'img_2',
                            event: {
                                error: function (d) {
                                    $(d.sender).hide()
                                    $(d.sender).parent().render({ img: 'https://homdgcat.wiki/homdgcat-res/Mat/UI_ItemIcon_120864.png', a: { loading: lazy } })
                                }
                            },
                            a: {
                                loading: lazy
