        ...
        "Ver": {
            ...
            "L": {
                "BattleSkills": [
                    ...
                    {
                        "Name": "セレモニアル · クリスタルショット",
                        "Desc": "チームにいるキャラクターが結晶反応による結晶の欠片を獲得した時、または月結晶反応を起こした時、ナヴィアは「裂晶の欠片」を1個獲得する。「裂晶の欠片」は最大6個まで所持可能。獲得するたびに、所持している「裂晶の欠片」の継続時間を更新する。月結晶反応によって、1秒毎にナヴィアに最大1個の「裂晶の欠片」を蓄積する。<br>スキル発動時、すべての「裂晶の欠片」を消費して優雅で致命的なガンブレラを展開する。そして敵を貫く「ロースラ晶弾」を多数発射して、命中した敵に<color style='color:#FFE699;'>岩元素ダメージ</color>を与える。<br>0/1/2/3個以上の「裂晶の欠片」を消費した時、発射される「ロースラ晶弾」はそれぞれ5/7/9/11発となる。「ロースラ晶弾」が同じ敵に命中するほど、その敵に与えるダメージがアップする。11発の「ロースラ晶弾」がすべて命中した時、本来の200%分のダメージを与える。<br>また、消費した「裂晶の欠片」が3個を超えている場合、超過した「裂晶の欠片」1個につき、該当の射撃によるダメージがさらに+15%。<br><br><color style='color:#FFD780;'>長押し</color><br>照準モードに入り、一定範囲内にある結晶反応で生じた結晶の欠片を持続的に吸収する。長押し終了時、一回押しの時と同じ「ロースラ晶弾」を発射する。<br><br>初期使用可能回数2回。<br><br><color style='color:#FFD780;'>アルケー：ウーシア</color><br>ナヴィアがガンブレラで射撃を行う時、迸発の刃を召喚し、ウーシアを帯びた<color style='color:#FFE699;'>岩元素ダメージ</color>を与える。一定時間ごとに発動が可能。<br><br><i>「距離を置くべき相手に、適切な距離を保つことも、社交儀礼の一部よ。ただ…まあ、やり方はいろいろあるけどね…」</i>",
                        "Icon": "Skill_S_Navia_01",
                        "ParamDesc": [
                            {
                                "Desc": "ロースラ晶弾の基礎ダメージ",
                    ...
                    {
                        "Name": "晴天を衝く霰弾のサルート",
                        "Desc": "棘薔薇の会の会長命令をもって、華麗なる「金薔薇の礼砲」を召喚し、前方の敵を激しく砲撃して<color style='color:#FFE699;'>岩元素範囲ダメージ</color>を与える。さらにその後、一定時間持続する「火力支援」を行い、一定時間ごとに近くの敵に<color style='color:#FFE699;'>岩元素ダメージ</color>を与える。<br>砲撃が敵に命中した時、ナヴィアは「裂晶の欠片」を1個獲得する。この効果は2.4秒毎に1回のみ発動可能。<br><br><i>「棘薔薇の会の礼砲は、交渉の成立を事前に祝うために、交渉の前にちょっとだけ発砲するの。あ、勘違いしないでね、威嚇の意味はまったくないから。」</i>",
                        "Icon": "Skill_E_Navia_01",
                        "ParamDesc": [
                            {
                                "Desc": "スキルダメージ",
                ...
                "PassiveSkills": [
                    {
                        "Name": "未知の流通ルート",
                        "Desc": "<color style='color:#FFD780;'>セレモニアル · クリスタルショット</color>を発動した後の4秒間、ナヴィアの通常攻撃、重撃、落下攻撃ダメージは、元素付与によって他の元素に変化しない<color style='color:#FFE699;'>岩元素ダメージ</color>へと変わる。この時、ナヴィアの通常攻撃、重撃、落下攻撃ダメージ+40%。",
                        "Icon": "UI_Talent_S_Navia_05"
                    },
                    {
                        "Name": "相互連携ネットワーク",
                        "Desc": "チーム内に<color style='color:#FF9999;'>炎元素</color>/<color style='color:#FFACFF;'>雷元素</color>/<color style='color:#99FFFF;'>氷元素</color>/<color style='color:#80C0FF;'>水元素</color>のキャラクターが1名いる毎に、ナヴィアの攻撃力+20%。この効果は最大2層まで重ね掛け可能。",
                        "Icon": "UI_Talent_S_Navia_06"
                    },
                    {
                        "Name": "きめ細やかなビジネス",
                        "Desc": "フォンテーヌで20時間かかる探索任務を完了した時、獲得する報酬+25%。",
                        "Icon": "UI_Talent_S_Navia_07"
                    }
                ],
                "Constellations": [
                    {
                        "Level": 1,
                        "Name": "淑女の距離感",
                        "Desc": "<color style='color:#FFD780;'>セレモニアル · クリスタルショット</color>発動時、「裂晶の欠片」を1個消費するごとに、ナヴィアは元素エネルギーを3ポイント回復し、<color style='color:#FFD780;'>晴天を衝く霰弾のサルート</color>のクールタイム-1秒。この方法による元素エネルギー回復は最大9ポイント、短縮できるクールタイムは最大3秒まで。",
                        "Icon": "UI_Talent_S_Navia_01"
                    },
                    {
                        "Level": 2,
                        "Name": "司令塔の追撃",
                        "Desc": "<color style='color:#FFD780;'>セレモニアル · クリスタルショット</color>発動時、「裂晶の欠片」を1個消費するごとに、今回のセレモニアル · クリスタルショットの会心率+12%。この方法でアップできる会心率は最大36%まで。<br>また、セレモニアル · クリスタルショットが敵に命中した時、命中した敵の付近に<color style='color:#FFD780;'>晴天を衝く霰弾のサルート</color>の「火力支援」を1回行う。セレモニアル · クリスタルショット1回につき、発動する「火力支援」は1回まで。この方法によって発動した「火力支援」のダメージは元素爆発ダメージと見なされる。",
                        "Icon": "UI_Talent_S_Navia_02"
                    },
                    {
                        "Level": 3,
                        "Name": "実業家の大局観",
                        "Desc": "<color style='color:#FFD780;'>セレモニアル · クリスタルショット</color>のスキルLv.+3。<br>最大Lv.15まで。",
                        "Icon": "UI_Talent_U_Navia_01"
                    },
                    {
                        "Level": 4,
                        "Name": "誓約者の非妥協",
                        "Desc": "<color style='color:#FFD780;'>晴天を衝く霰弾のサルート</color>が敵に命中した時、その敵の<color style='color:#FFE699;'>岩元素耐性</color>-20%、継続時間8秒。",
                        "Icon": "UI_Talent_S_Navia_03"
                    },
                    {
                        "Level": 5,
                        "Name": "交渉人の毅然たる協議",
                        "Desc": "<color style='color:#FFD780;'>晴天を衝く霰弾のサルート</color>のスキルLv.+3。<br>最大Lv.15まで。",
                        "Icon": "UI_Talent_U_Navia_02"
                    },
                    {
                        "Level": 6,
                        "Name": "棘薔薇会長の巧妙なる手腕",
                        "Desc": "<color style='color:#FFD780;'>セレモニアル · クリスタルショット</color>発動時、消費した「裂晶の欠片」が3個を超えている場合、超えた分1個につき、今回のセレモニアル · クリスタルショットの会心ダメージ+45%。さらに、超えた分の「裂晶の欠片」は発動後に返還される。",
                        "Icon": "UI_Talent_S_Navia_04"
                    }
                ]
            }
