        ...
        "Ver": {
            ...
            "L": {
                "BattleSkills": [
                    ...
                    {
                        "Name": "近迫阻止射撃 · 速",
                        "Desc": "シュヴルーズは銃床を素早く肩にあて、照準を覗き込み、敵を射撃して<color style='color:#FF9999;'>炎元素範囲ダメージ</color>を与える。<br>シュヴルーズが射撃を行った後の一定時間、フィールド上の自身のキャラクターのHPを持続的に回復する。回復量はシュヴルーズのHP上限によって決まる。<br>長押しによって攻撃方法が変わる。<br><br><color style='color:#FFD780;'>長押し</color><br>照準モードに入り、照準範囲内の敵一体をロックオンし、より精確な阻止射撃を行う。シュヴルーズが「マグナムブレット」を持っている場合、代わりにそれを発射し、広範囲かつより大きな<color style='color:#FF9999;'>炎元素ダメージ</color>を与える。<br>シュヴルーズは、付近にいるチーム内キャラクターが過負荷反応を起こした時、「マグナムブレット」を1個獲得する。「マグナムブレット」は最大1個まで所持可能。<br><br><color style='color:#FFD780;'>アルケー：ウーシア</color><br>シュヴルーズの「近迫阻止射撃 · 速」が命中した時、迸発の刃を召喚し、ウーシアを帯びた<color style='color:#FF9999;'>炎元素ダメージ</color>を与える。一定時間ごとに発動が可能。<br><br><i>「実は、訓練マニュアルには『阻止射撃』という用語しかなかった。だが、ある小説の主人公が、専門用語を用いた技名は味方の士気を上げ、その気迫で敵の先手を取れると言っていた…とても理にかなっていたから、マニュアルを変更したのだ。」</i>",
                        "Icon": "Skill_S_Chevreuse_01",
                        "ParamDesc": [
                            {
                                "Desc": "一回押しダメージ",
                            ...
                            },
                            {
                                "Desc": "継続回復量",
                                "ParamLevelList": [
                                    "HP上限2.6667%+256.79184",
                                    "HP上限2.8667%+282.47458",
                                    "HP上限3.0667%+310.29758",
                                    "HP上限3.3333%+340.26077",
                                    "HP上限3.5333%+372.36423",
                                    "HP上限3.7333%+406.60788",
                                    "HP上限4.0%+442.9918",
                                    "HP上限4.2667%+481.51593",
                                    "HP上限4.5333%+522.1803",
                                    "HP上限4.8%+564.98486",
                                    "HP上限5.0667%+609.9297",
                                    "HP上限5.3333%+657.0147",
                    ...
                    {
                        "Name": "円形爆撃戦術 · 轟",
                        "Desc": "シュヴルーズは銃を構え、敵に向けて轟榴弾を発射し<color style='color:#FF9999;'>炎元素範囲ダメージ</color>を与える。轟榴弾は命中した後、複数の二次榴弾に分裂する。<br>二次榴弾は短時間後に爆発し、近くの敵に<color style='color:#FF9999;'>炎元素ダメージ</color>を与える。<br><br><i>「理論上、正方形に並べた爆撃をすれば、陣形を構える敵を効果的に攻撃することができる。だが、残念ながら轟榴弾の爆発範囲はホールケーキのようにほぼ円形だ。そのため、飛び散る榴弾もケーキの上にある果物のように、円形にしか並べられないのだ。」</i>",
                        "Icon": "Skill_E_Chevreuse_01",
                        "ParamDesc": [
                            {
                                "Desc": "轟榴弾のダメージ",
                ...
                "PassiveSkills": [
                    {
                        "Name": "尖兵協同戦術",
                        "Desc": "チーム全員の元素タイプが<color style='color:#FF9999;'>炎元素</color>または<color style='color:#FFACFF;'>雷元素</color>であり、かつ炎元素と雷元素のキャラクターが少なくとも一人ずついる時、シュヴルーズは周囲のチーム全員に「協同戦術」を付与する。付与されたキャラクターが過負荷反応を起こした後、その過負荷反応による影響を受けた敵の<color style='color:#FF9999;'>炎元素</color>耐性および<color style='color:#FFACFF;'>雷元素</color>耐性-40%、継続時間6秒。<br>チーム内キャラクターの元素タイプが固有天賦の条件を満たさない場合、既存の協同戦術効果はクリアされる。",
                        "Icon": "UI_Talent_S_Chevreuse_05"
                    },
                    {
                        "Name": "縦陣戦力統括",
                        "Desc": "シュヴルーズが<color style='color:#FFD780;'>近迫阻止射撃 · 速</color>の「マグナムブレット」を発射した後、次の効果を発動する。シュヴルーズのHP上限を基準とし、HP上限1000毎に周囲のチームにいる<color style='color:#FF9999;'>炎元素</color>と<color style='color:#FFACFF;'>雷元素</color>キャラクターの攻撃力+1%、継続時間30秒。この方法でアップできる攻撃力は最大40%まで。",
                        "Icon": "UI_Talent_S_Chevreuse_06"
                    },
                    {
                        "Name": "迅速行軍戦略",
                ...
                "Constellations": [
                    {
                        "Level": 1,
                        "Name": "戦線維持の胆力",
                        "Desc": "フィールド上にいる「協同戦術」状態のキャラクター（シュヴルーズ自身を除く）が過負荷反応を起こした時、元素エネルギーを6ポイント回復する。この効果は10秒毎に1回のみ発動可能。<br>固有天賦「尖兵協同戦術」を解放する必要がある。",
                        "Icon": "UI_Talent_S_Chevreuse_01"
                    },
                    {
                        "Level": 2,
                        "Name": "誘導殉爆の狙撃",
                        "Desc": "<color style='color:#FFD780;'>近迫阻止射撃 · 速</color>の長押しによる攻撃が命中した時、命中した位置付近に連鎖殉爆を2回起こす。それぞれの殉爆はシュヴルーズの攻撃力120%分の<color style='color:#FF9999;'>炎元素ダメージ</color>を与える。この効果は10秒毎に1回のみ発動可能。殉爆によるダメージは元素スキルダメージと見なされる。",
                        "Icon": "UI_Talent_S_Chevreuse_02"
                    },
                    {
                        "Level": 3,
                        "Name": "熟練装弾の技術",
                        "Desc": "<color style='color:#FFD780;'>近迫阻止射撃 · 速</color>のスキルLv.+3。<br>最大Lv.15まで。",
                        "Icon": "UI_Talent_U_Chevreuse_01"
                    },
                    {
                        "Level": 4,
                        "Name": "多重速射の秘訣",
                        "Desc": "<color style='color:#FFD780;'>円形爆撃戦術 · 轟</color>発動後、シュヴルーズが<color style='color:#FFD780;'>近迫阻止射撃 · 速</color>を長押しで発動すると、近迫阻止射撃 · 速にクールタイムが発生しない。この効果は最大で6秒間持続でき、近迫阻止射撃 · 速を2回長押しで発動した後に解除される。",
                        "Icon": "UI_Talent_S_Chevreuse_03"
                    },
                    {
                        "Level": 5,
                        "Name": "火力増幅の毀傷",
                        "Desc": "<color style='color:#FFD780;'>円形爆撃戦術 · 轟</color>のスキルLv.+3。<br>最大Lv.15まで。",
                        "Icon": "UI_Talent_U_Chevreuse_02"
                    },
                    {
                        "Level": 6,
                        "Name": "罪過終止の追捕",
                        "Desc": "<color style='color:#FFD780;'>近迫阻止射撃 · 速</color>の治療効果が12秒継続した後、周囲のチーム全員のHPを1回だけ回復する。回復量はシュヴルーズのHP上限の10%に相当する。<br>チームにいるキャラクターが「近迫阻止射撃 · 速」の治療効果を受けた後、<color style='color:#FF9999;'>炎元素ダメージ</color>+20%、<color style='color:#FFACFF;'>雷元素ダメージ</color>+20%、継続時間8秒。この効果は最大3層まで重ねられる。層ごとに継続時間は独立して計算される。",
                        "Icon": "UI_Talent_S_Chevreuse_04"
                    }
                ]
            }
