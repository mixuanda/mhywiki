        ...
        "Ver": {
            ...
            "L": {
                "BattleSkills": [
                    ...
                    {
                        "Name": "Ceremonial Crystalshot",
                        "Desc": "When a character in the party obtains an Elemental Shard created from the Crystallize reaction, or when they trigger the Lunar-Crystallize reaction, Navia will gain 1 Crystal Shrapnel stack. Navia can have up to 6 stacks of Crystal Shrapnel at once. Each time Crystal Shrapnel gain is triggered, the duration of the Crystal Shrapnel stacks you already have will be reset. Through the Lunar-Crystallize reaction, Navia will gain up to 1 Crystal Shrapnel stack every second.<br>When she fires, Navia will consume all Crystal Shrapnel stacks and open her elegant yet lethal Gunbrella, firing multiple Rosula Shardshots that can penetrate opponents, dealing <color style='color:#FFE699;'>Geo DMG</color> to opponents hit.<br>When 0/1/2/3 or more stacks of Crystal Shrapnel are consumed, 5/7/9/11 Rosula Shardshots will be fired respectively. The more Rosula Shardshots that strike a single opponent, the greater the DMG dealt to them. When all 11 Rosula Shardshots strike, 200% of the original amount of DMG is dealt.<br>In addition, when more than 3 stacks of Crystal Shrapnel are consumed, every stack consumed beyond those 3 will increase the DMG dealt by this Gunbrella attack by an additional 15%.<br><br><color style='color:#FFD780;'>Hold</color><br>Enter Aiming Mode, continually collecting nearby Elemental Shards created by Crystallize reactions. When released, fire Rosula Shardshots with the same effect as when the skill is Tapped.<br><br>Two initial charges.<br><br><color style='color:#FFD780;'>Arkhe: Ousia</color><br>Periodically, when Navia fires her Gunbrella, a Surging Blade will be summoned, dealing Ousia-aligned <color style='color:#FFE699;'>Geo DMG</color>.<br><br><i>\"Maintaining the appropriate distance with those whom distance should be maintained is an essential part of etiquette. Naturally, there are also many ways to do this...\"</i>",
                        "Icon": "Skill_S_Navia_01",
                        "ParamDesc": [
                            {
                                "Desc": "Rosula Shardshot Base DMG",
                ...
                "Constellations": [
                    {
                        "Level": 1,
                        "Name": "A Lady's Rules for Keeping a Courteous Distance",
                        "Desc": "Each stack of Crystal Shrapnel consumed when Navia uses <color style='color:#FFD780;'>Ceremonial Crystalshot</color> will restore 3 Energy to her and decrease the CD of <color style='color:#FFD780;'>As the Sunlit Sky's Singing Salute</color> by 1s. Up to 9 Energy can be gained this way, and the CD of \"As the Sunlit Sky's Singing Salute\" can be decreased by up to 3s.",
                        "Icon": "UI_Talent_S_Navia_01"
                    },
                    {
                        "Level": 2,
                        "Name": "The President's Pursuit of Victory",
                        "Desc": "Each stack of Crystal Shrapnel consumed will increase the CRIT Rate of this <color style='color:#FFD780;'>Ceremonial Crystalshot</color> instance by 12%. CRIT Rate can be increased by up to 36% in this way.<br>In addition, when Ceremonial Crystalshot hits an opponent, one Cannon Fire Support shot from <color style='color:#FFD780;'>As the Sunlit Sky's Singing Salute</color> will strike near the location of the hit. Up to one instance of Cannon Fire Support can be triggered each time Ceremonial Crystalshot is used, and DMG dealt by said Cannon Fire Support this way is considered Elemental Burst DMG.",
                        "Icon": "UI_Talent_S_Navia_02"
                    },
                    {
                        "Level": 3,
                    ...
                    },
                    {
                        "Level": 6,
                        "Name": "The Flexible Finesse of the Spina's President",
                        "Desc": "If more than 3 stacks of Crystal Shrapnel are consumed when using <color style='color:#FFD780;'>Ceremonial Crystalshot</color>, each stack consumed beyond the first 3 increases the CRIT DMG of that Ceremonial Crystalshot by 45%, and any stacks consumed beyond the first 3 are returned to Navia.",
                        "Icon": "UI_Talent_S_Navia_04"
                    }
                ]
            }
