    ...
    "Gaming": {
        "Ver": {
            ...
            "L": {
                "BattleSkills": [
                    {
                        "Name": "Разорванные когтями звёзды",
                        "Desc": "<color style='color:#FFD780;'>Обычная атака:</color><br>До четырёх быстрых ударов.<br><br><color style='color:#FFD780;'>Заряженная атака:</color><br>Вращающаяся атака по окружающим врагам, на которую непрерывно тратится выносливость.<br>После вращения проводит дополнительную мощную рубящую атаку.<br><br><color style='color:#FFD780;'>Атака в падении:</color><br>Стремительно падает на землю, атакуя всех врагов на пути. Приземлившись, наносит урон по площади.",
                        "Icon": "Skill_A_04",
                        "ParamDesc": [
                            {
                                "Desc": "Урон атаки 1",
                    ...
                    {
                        "Name": "Восхождение благовещего зверя",
                        "Desc": "Выполняет рывок вперёд, используя искусство Ушоу, а после контакта с целью или поверхностью подпрыгивает высоко в воздух.<br>Если Ка Мин, поднявшись с помощью Восхождения благовещего зверя в воздух, мгновенно выполняет атаку в падении, она значительно усиливается, становясь атакой в падении: Ступающий по облакам.<br><br><color style='color:#FFD780;'>Атака в падении: Ступающий по облакам</color><br>Урон атаки в падении Восхождения благовещего зверя конвертируется в <color style='color:#FF9999;'>Пиро урон</color>, который не может быть отменён другими инфузиями. Приземлившись, Ка Мин расходует определённое количество HP. Этот эффект не может опустить HP Ка Мина ниже 10% от его макс. HP.<br>Урон Ступающего по облакам считается уроном атаки в падении.<br><br><i>«Благой зверь скачет и щиплет травы - значит, счастье уже на пороге. Пусть здоровье и богатство придут к нам, а жизнь станет краше!»</i>",
                        "Icon": "Skill_S_Gaming_01",
                        "ParamDesc": [
                            {
                                "Desc": "Урон атаки в падении: Ступающий по облакам",
                                "ParamLevelList": [
                                    "230.4%",
                                    "247.68%",
                                    "264.96%",
                    ...
                    {
                        "Name": "Золотой танец суаньни",
                        "Desc": "Ка Мин принимает стойку Ушоу, кратковременно приобретает <color style='color:#FF9999;'>эффект Пиро</color>, восстанавливает себе определённое количество HP и призывает надёжного компаньона, суаньни Ман Чая, который врезается в цель и наносит <color style='color:#FF9999;'>Пиро урон по площади</color>.<br>После удара по цели Ман Чай перекатывается в сторону, затем направляется к Ка Мину. Воссоединившись с Ка Мином, Ман Чай покидает поле боя и сбрасывает откат элементального навыка Восхождение благовещего зверя Ка Мина.<br>Когда Ка Мин находится в стойке Ушоу, его сопротивление прерыванию увеличивается, а если HP Ка Мина выше 50%, приземление атаки в падении: Ступающий по облакам или завершение рывка вперёд Восхождения благовещего зверя призывает Ман Чая ещё раз.<br>Одновременно может существовать только 1 призванный самим Ка Мином Ман Чай.<br>Эффект исчезает, когда Ка Мин покидает поле боя.<br><br><i>«Златой зверь, вестник счастья, несёт море огней и процветание! Это и есть жизнь в изобилии!»</i>",
                        "Icon": "Skill_E_Gaming_01",
                        "ParamDesc": [
                            {
                                "Desc": "Урон удара суаньни Ман Чая",
                                "ParamLevelList": [
                                    "370.4%",
                                    "398.18%",
                                    "425.96%",
                ...
                "PassiveSkills": [
                    {
                        "Name": "Танец мира",
                        "Desc": "После попадания атаки в падении: Ступающий по облакам навыка <color style='color:#FFD780;'>Восхождение благовещего зверя</color> по противнику Ка Мин раз в 0,2 сек. восстанавливает HP пропорционально 1,5% макс. HP Ка Мина. Эффект длится 0,8 сек.",
                        "Icon": "UI_Talent_S_Gaming_05"
                    },
                    {
                        "Name": "Дух благоденствия",
                        "Desc": "Когда HP Ка Мина опускается ниже 50%, он получает 20% бонус получаемого лечения. Если HP Ка Мина равно или выше 50%, урон атаки в падении: Ступающий по облакам увеличивается на 20%.",
                        "Icon": "UI_Talent_S_Gaming_06"
                    },
                    {
                        "Name": "Бег пробуждённого зверя",
                ...
                "Constellations": [
                    {
                        "Level": 1,
                        "Name": "Несущий благословение",
                        "Desc": "Ман Чай <color style='color:#FFD780;'>Золотого танца суаньни</color>, воссоединяясь с Ка Мином, восстанавливает ему 15% HP.",
                        "Icon": "UI_Talent_S_Gaming_01"
                    },
                    {
                        "Level": 2,
                        "Name": "Цветы сливы под ногами",
                        "Desc": "Когда Ка Мин получает лечение с избытком, его сила атаки повышается на 20% на 5 сек.",
                        "Icon": "UI_Talent_S_Gaming_02"
                    },
                    {
                        "Level": 3,
                        "Name": "Пробуждающийся дух",
                        "Desc": "Увеличивает уровень навыка <color style='color:#FFD780;'>Восхождение благовещего зверя</color> на 3.<br>Макс. уровень: 15",
                        "Icon": "UI_Talent_U_Gaming_01"
                    },
                    {
                        "Level": 4,
                        "Name": "Паря над облаками",
                        "Desc": "Попадания атаки в падении: Ступающий по облакам навыка <color style='color:#FFD780;'>Восхождение благовещего зверя</color> по противнику восстанавливают Ка Мину 2 ед. энергии. Этот эффект может возникнуть один раз в 0,2 сек.",
                        "Icon": "UI_Talent_S_Gaming_03"
                    },
                    {
                        "Level": 5,
                        "Name": "Устрашающий зло рёв",
                        "Desc": "Увеличивает уровень навыка <color style='color:#FFD780;'>Золотой танец суаньни</color> на 3.<br>Макс. уровень: 15",
                        "Icon": "UI_Talent_U_Gaming_02"
                    },
                    {
                        "Level": 6,
                        "Name": "Приручить всех зверей",
                        "Desc": "Повышает шанс крит. попадания атаки в падении: Ступающий по облакам навыка <color style='color:#FFD780;'>Восхождение благовещего зверя</color> на 20%, крит. урон - на 40%, а также увеличивает радиус атаки.",
                        "Icon": "UI_Talent_S_Gaming_04"
                    }
                ]
            }
