    ...
    "Liuyun": {
        "Ver": {
            ...
            "L": {
                "BattleSkills": [
                    {
                        "Name": "Слово ветра и цветка",
                        "Desc": "<color style='color:#FFD780;'>Обычная атака:</color><br>Призывает кружащие ветра, и выполняет до четырёх атак, наносящих <color style='color:#80FFD7;'>Анемо урон</color>.<br><br><color style='color:#FFD780;'>Заряженная атака:</color><br>Тратит определённое количество выносливости и по прямой линии выпускает кольцо ветра, наносящее врагам на пути <color style='color:#80FFD7;'>Анемо урон</color>.<br><br><color style='color:#FFD780;'>Атака в падении:</color><br>Собрав мощь Анемо, стремительно падает на землю, атакуя всех врагов на пути. Приземлившись, наносит <color style='color:#80FFD7;'>Анемо урон по площади</color>.",
                        "Icon": "Skill_A_Catalyst_MD",
                        "ParamDesc": [
                            {
                                "Desc": "Урон атаки 1",
                    ...
                    {
                        "Name": "Белые облака на заре",
                        "Desc": "Сянь Юнь входит в состояние Превращения облаков, в котором она не получает урон от падения, и один раз использует Небесную лестницу.<br>В этом состоянии её атака в падении превращается в Волну плывущих облаков, которая наносит <color style='color:#80FFD7;'>Анемо урон по площади</color> и завершает состояние Превращения облаков. Её урон считается уроном атаки в падении.<br>Каждое применение Небесной лестницы в этом состоянии увеличивает урон и площадь поражения следующей Волны плывущих облаков.<br><br><color style='color:#FFD780;'>Небесная лестница</color><br>Может быть активирована в воздухе. Сянь Юнь совершает рывок вперёд, нанося целям на пути <color style='color:#80FFD7;'>Анемо урон</color>.<br>В течение одного состояния Превращения облаков Небесную лестницу можно использовать до 3 раз, причём один и тот же противник может получить урон Небесной лестницы только один раз.<br>Если в течение короткого промежутка времени не активировать Небесную лестницу, состояние Превращения облаков исчезает.<br><br>Если во время текущего состояния Превращения облаков не вызывать Волну плывущих облаков, последующий откат навыка Белые облака на заре сокращается на 3 сек.<br><br><i>Пожимая Хранителю Облаков руку, будьте осторожны - это всё-таки рука Адепта.</i>",
                        "Icon": "Skill_S_Liuyun_01",
                        "ParamDesc": [
                            {
                                "Desc": "Урон навыка",
                            ...
                            {
                                "Desc": "Урон Волны плывущих облаков",
                                "ParamLevelList": [
                                    "116.0%/148.0%/337.6%",
                                    "124.7%/159.1%/362.92%",
                                    "133.4%/170.2%/388.24%",
                    ...
                    {
                        "Name": "Сумеречное собрание звёзд",
                        "Desc": "Призывает божественный ветер, который наносит <color style='color:#80FFD7;'>Анемо урон по площади</color>, восстанавливает HP всем окружающим членам отряда пропорционально силе атаки Сянь Юнь и призывает механизм «Сплетение звёзд».<br><br><color style='color:#FFD780;'>Сплетение звёзд</color><br> ·  Следует за активным персонажем и периодически восстанавливает HP всем членам отряда поблизости пропорционально силе атаки Сянь Юнь.<br> ·  Изначально имеет 8 уровней Поддержки Адептов. Во время действия Поддержки Адептов высота прыжка активных членов отряда поблизости повышена.<br> ·  Когда активный персонаж завершает атаку в падении, Сплетение звёзд расходует 1 уровень Поддержки Адептов и наносит <color style='color:#80FFD7;'>Анемо урон по площади</color>.<br>На поле боя одновременно может быть только одно Сплетение звёзд.<br><br><i>Это последнее из серии чудесных изобретений звезды и луны, которому предшествуют Чудо кулинарной машинерии, Скорый снегоход, Волшебный домработник, Парящий переносной механизм и Садовник. Образчики из этой серии должны были стать подарками юным людям, обожаемых Хранителем Облаков, и к одному полуадепту отношения не имели. К сожалению, некая ученица, которой предстояло принять сей дар, с отсутствующим выражением молвила «Нет, спасибо».<br>Так что Хранителю Облаков пришлось оставить его у себя.</i>",
                        "Icon": "Skill_E_Liuyun_01",
                        "ParamDesc": [
                            {
                                "Desc": "Урон навыка",
                            ...
                            },
                            {
                                "Desc": "Лечение",
                                "ParamLevelList": [
                                    "92.16% силы атаки + 577.7816",
                                    "99.072% силы атаки + 635.5678",
                                    "105.984% силы атаки + 698.1695",
                                    "115.2% силы атаки + 765.58673",
                                    "122.112% силы атаки + 837.8195",
                                    "129.024% силы атаки + 914.86774",
                                    "138.24% силы атаки + 996.7315",
                                    "147.456% силы атаки + 1083.4108",
                                    "156.672% силы атаки + 1174.9056",
                                    "165.888% силы атаки + 1271.216",
                                    "175.104% силы атаки + 1372.3418",
                                    "184.32% силы атаки + 1478.2831",
                                    "195.84% силы атаки + 1589.04",
                                    "207.36% силы атаки + 1704.6124",
                                    "218.88% силы атаки + 1825.0"
                                ]
                            },
                            {
                                "Desc": "Периодическое лечение",
                                "ParamLevelList": [
                                    "43.008% силы атаки + 269.6314",
                                    "46.2336% силы атаки + 296.59833",
                                    "49.4592% силы атаки + 325.81244",
                                    "53.76% силы атаки + 357.2738",
                                    "56.9856% силы атаки + 390.98242",
                                    "60.2112% силы атаки + 426.9383",
                                    "64.512% силы атаки + 465.1414",
                                    "68.8128% силы атаки + 505.5917",
                                    "73.1136% силы атаки + 548.2893",
                                    "77.4144% силы атаки + 593.23413",
                                    "81.7152% силы атаки + 640.42615",
                                    "86.016% силы атаки + 689.8655",
                                    "91.392% силы атаки + 741.552",
                                    "96.768% силы атаки + 795.4858",
                                    "102.144% силы атаки + 851.6668"
                                ]
                            },
                            {
                                "Desc": "Длительность",
                ...
                "PassiveSkills": [
                    {
                        "Name": "Белое перо на благом ветру",
                        "Desc": "Каждый противник, поражённый Волной плывущих облаков навыка <color style='color:#FFD780;'>Белые облака на заре</color>, на 20 сек. наделяет всех членов отряда поблизости 1 уровнем эффекта Перо на ветру. Этот эффект складывается до 4 раз и увеличивает шанс крит. попадания атаки в падении на 4%/6%/8%/10% соответственно.<br>Длительность уровней Пера на ветру, возникающих при попадании по противнику, рассчитывается отдельно друг от друга.",
                        "Icon": "UI_Talent_S_Liuyun_05"
                    },
                    {
                        "Name": "Адепт в своей обители",
                        "Desc": "Сплетение звёзд <color style='color:#FFD780;'>Сумеречного собрания звёзд</color> с действующей Поддержкой Адептов повышает урон ударной волны атаки в падении активных персонажей отряда поблизости на 200% от силы атаки Сянь Юнь. Максимальное увеличение урона, полученное таким образом, не может превышать 9000.<br>Одна ударная волна атаки в падении может нанести данный повышенный урон только одному противнику. Каждый персонаж может активировать этот эффект один раз в 0,4 сек.",
                        "Icon": "UI_Talent_S_Liuyun_06"
                    },
                    {
                        "Name": "Форма журавля",
                ...
                "Constellations": [
                    {
                        "Level": 1,
                        "Name": "Ветер очищения",
                        "Desc": "Увеличивает количество зарядов навыка <color style='color:#FFD780;'>Белые облака на заре</color> на 1.",
                        "Icon": "UI_Talent_S_Liuyun_01"
                    },
                    {
                        "Level": 2,
                        "Name": "Отстранившись от мира",
                        "Desc": "После применения Небесной лестницы навыка <color style='color:#FFD780;'>Белые облака на заре</color> сила атаки Сянь Юнь повышается на 20% на 15 сек.<br>Кроме того, эффект пассивного таланта Адепт в своей обители становится сильнее: Сплетение звёзд <color style='color:#FFD780;'>Сумеречного собрания звёзд</color> с действующей Поддержкой Адептов повышает урон ударной волны атак в падении активных персонажей отряда поблизости на 400% от силы атаки Сянь Юнь. Максимальное увеличение урона, полученное таким образом, не может превышать 18 000.<br>Одна ударная волна атаки в падении может нанести данный повышенный урон только одному противнику. Каждый персонаж может активировать этот эффект один раз в 0,4 сек.<br>Требуется разблокировать пассивный талант Адепт в своей обители.",
                        "Icon": "UI_Talent_S_Liuyun_02"
                    },
                    {
                        "Level": 3,
                        "Name": "Создания звезды и луны",
                        "Desc": "Увеличивает уровень навыка <color style='color:#FFD780;'>Сумеречное собрание звёзд</color> на 3.<br>Макс. уровень: 15",
                        "Icon": "UI_Talent_U_Liuyun_02"
                    },
                    {
                        "Level": 4,
                        "Name": "Таинственное жемчужное просо",
                        "Desc": "Попадания Волны плывущих облаков по противнику во время одного и того же Превращения облаков навыка <color style='color:#FFD780;'>Белые облака на заре</color>, во время которого Небесная лестница была задействована 1/2/3 раза, восстанавливают HP всем членам отряда поблизости в размере 50%/80%/150% от силы атаки Сянь Юнь соответственно. Этот эффект может возникнуть раз в 5 сек.",
                        "Icon": "UI_Talent_S_Liuyun_03"
                    },
                    {
                        "Level": 5,
                        "Name": "Верхом на розовых облаках",
                        "Desc": "Увеличивает уровень навыка <color style='color:#FFD780;'>Белые облака на заре</color> на 3.<br>Макс. уровень: 15",
                        "Icon": "UI_Talent_U_Liuyun_01"
                    },
                    {
                        "Level": 6,
                        "Name": "Дух Хранителя Облаков",
                        "Desc": "После того как Сянь Юнь использует Небесную лестницу 1/2/3 раза во время действия одного и того же Превращения облаков навыка <color style='color:#FFD780;'>Белые облака на заре</color>, крит. урон Волны плывущих облаков этого Превращения облаков повышается на 15%/35%/70% соответственно.<br>В течение 16 сек. после применения <color style='color:#FFD780;'>Сумеречного собрания звёзд</color> навык Белые облака на заре не переходит в режим отката. После 8 активаций Белых облаков на заре Сянь Юнь этот эффект исчезает.",
                        "Icon": "UI_Talent_S_Liuyun_04"
                    }
                ]
            }
